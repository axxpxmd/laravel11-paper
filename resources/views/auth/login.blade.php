        ...
        <div class="inner">
            ...
            <form method="POST" action="{{ route('login') }}" class="needs-validation" style="border-radius: 20px" novalidate>
                ...
                <div class="text-center" style="margin-top: -40px !important;">
                    <p class="fw-bold fs-25 text-black">LARAVEL PAPER</p>
                    <p class="text-black fs-14 mt-1">Template paper + Laravel 11</p>
                </div>
                <div class="mt-4">
            ...
            <p class="text-center text-white fw-bold fs-14 mt-2">LARAVEL PAPER © {{ date('Y') }}</p>
